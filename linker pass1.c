...
void main()
{
    ...
    FILE *fp1, *fp2;
    int duplicate_cs = 0; // Flag to track duplicate control section names
    fp1 = fopen("objectprogram.txt", "r");
    ...
    while (strcmp(input, "END") != 0)
    {
        ...
        {
            fscanf(fp1, "%s", name);
            // Check for duplicate control section name
            ...
            if (duplicate_cs) // If duplicate found, break the loop
                break;
